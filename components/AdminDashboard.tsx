          ...
          {activeTab === 'scoring' && (
            <div className="space-y-12">
              ...
              {selectedEventId ? (
                ...
                <div className="py-48 flex flex-col items-center justify-center border-2 border-dashed border-white/5 rounded-[80px] bg-slate-900/5">
                   <div className="p-10 bg-white/5 rounded-[40px] mb-8 border border-white/5">
                     <Target size={80} className="text-slate-800" />
                   </div>
                   <h3 className="text-3xl font-black uppercase tracking-tighter italic text-slate-500 mb-4">TERMINAL OFFLINE</h3>
                   <p className="text-slate-600 font-black uppercase tracking-[0.4em] text-xs">Select a cycle core to engage data matrix</p>
                </div>
              )}
            </div>
          )}
            ...
            <div className="space-y-12">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                <div className="glass-card p-10 rounded-[40px] border-white/5 bg-slate-900/20 space-y-6">
                  ...
                  <CMSInput label="Hero Action Image (URL)" icon={<ImageIcon size={16} />} value={localConfig.hero_image} onChange={(v: string) => handleConfigChange('hero_image', v)} />
                </div>
                ...
                <div className="glass-card p-10 rounded-[40px] border-white/5 bg-slate-900/20 space-y-6">
                  ...
                  <CMSArea label="About Club" icon={<FileText size={16} />} value={localConfig.about_description} onChange={(v: string) => handleConfigChange('about_description', v)} />
                  <CMSInput label="Recruitment Link" icon={<Globe size={16} />} value={localConfig.recruitment_link} onChange={(v: string) => handleConfigChange('recruitment_link', v)} />
